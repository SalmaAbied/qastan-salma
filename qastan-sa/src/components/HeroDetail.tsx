...
function HeroDetail() {
  return (
    <HelmetProvider>
      <Helmet>
        <title>Onze Oplossingen - Qastan</title>
        <meta
          name="description"
          content="Ontdek de diverse oplossingen van Qastan voor bedrijven, inclusief digitalisering, automatisering en IT-beheer. Vraag vandaag nog de gepaste oplossing voor uw bedrijf aan."
        />
        <meta
          name="keywords"
          content="oplossingen, digitalisering, automatisering, IT-beheer, Qastan, bedrijfsoplossingen"
        />
      </Helmet>
