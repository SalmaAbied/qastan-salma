  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
      <div className="flex justify-start mb-4">
        <span className="bg-lightblue text-white text-sm font-bold py-2 px-4 rounded-full">
          {badgeText}
        </span>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <p className="mt-4 text-lg mb-10 break-words text-gray-700">
            {paragraph}
          </p>
          <a
            href={buttonLink}
            className="inline-block py-2 px-4 bg-darkorange transition duration-300 rounded-full text-white text-base hover:bg-lightblue font-medium"
          >
            {buttonText}
          </a>
        </div>
