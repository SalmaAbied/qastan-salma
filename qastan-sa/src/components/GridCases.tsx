          ...
          <div className="flex flex-col w-full mb-10 sm:flex-row">
              ...
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                <div className="relative h-full p-5 bg-slate-50 rounded-lg drop-shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://media.licdn.com/dms/image/D4E0BAQGrN84NZA-KIQ/company-logo_200_200/0/1714979889219/interieur_avenue_gaverzicht_logo?e=2147483647&v=beta&t=vFh3qDgsE82Obq4Yme-LRhdDG87o0cRpiQvBMxcs-Xg" alt="" className="w-12 h-12 rounded-full drop-shadow-lg object-cover" />
            ...
            <div className="w-full sm:w-1/2">
              <div className="relative h-full ml-0 md:mr-10">
                <div className="relative h-full p-5 bg-slate-50 rounded-lg drop-shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://cdn.worldvectorlogo.com/logos/avia-5.svg" alt="" className="w-12 h-12 rounded-full drop-shadow-lg object-cover" />
          ...
          <div className="flex flex-col w-full mb-5 sm:flex-row">
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                <div className="relative h-full p-5 bg-slate-50 rounded-lg drop-shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://www.qastan.be/swfiles/files/Frame.svg?nc=1709650208" alt="" className="w-12 h-12 rounded-full drop-shadow-lg object-cover" />
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                <div className="relative h-full p-5 bg-slate-50 rounded-lg drop-shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://www.qastan.be/swfiles/files/Brouwerij-Van-Honsebrouck.jpg?nc=1709650208" alt="" className="w-12 h-12 rounded-full drop-shadow-lg object-cover" />
            ...
            <div className="w-full sm:w-1/2">
              <div className="relative h-full ml-0 md:mr-10">
                <div className="relative h-full p-5 bg-slate-50 rounded-lg drop-shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://www.qastan.be/swfiles/files/club-logo-kv-kortrijk-qastan.png?nc=1709650208" alt="" className="w-12 h-12 rounded-full drop-shadow-lg object-cover" />
