...
function Intro() {
  return (
    <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:gap-4 md:mt-4 px-2">
      <div className="bg-bggray rounded-b-3xl md:rounded-3xl sm:mr-0 p-8 flex flex-col justify-between shadow-lg shadow-darkblue/50">
      ...
      <div
        className="bg-bggray rounded-b-3xl sm:rounded-bl-none md:rounded-3xl shadow-lg shadow-darkblue/50"
        style={{
