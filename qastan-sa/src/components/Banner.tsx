...
function Banner() {
  return (
    <HelmetProvider>
      <Helmet>
        <title>Samen Duiken in Digitalisering - Qastan</title>
        <meta
          name="description"
          content="Bij Qastan helpen we je graag verder na een verkennend gesprek. We luisteren naar jouw noden, stellen een gepaste oplossing voor en laten je bedrijf vliegen!"
        />
        <meta
          name="keywords"
          content="Qastan, digitalisering, verkennend gesprek, oplossingen, bedrijf laten groeien"
        />
      </Helmet>
