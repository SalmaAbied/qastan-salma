      ...
      <div className="container relative flex flex-col justify-between h-full px-10 mx-auto xl:px-0 mt-5">
        ...
        <div className="w-full">
          <div className="flex flex-col w-full mb-10 sm:flex-row">
            ...
            <div className="w-full sm:w-1/2">
              <div className="relative h-full ml-0 md:mr-10">
                <div className="relative h-full p-5 bg-lightblue/20 rounded-lg shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://www.qastan.be/swfiles/files/QastanPartner_Jorosoft-tab.png?nc=1715848923" alt="" className="w-12 h-12 rounded-full shadow-lg object-cover" />
          ...
          <div className="flex flex-col w-full mb-5 sm:flex-row">
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                <div className="relative h-full p-5 bg-lightblue/50 rounded-lg shadow-lg">
                  <div className="flex items-center -mt-1">
                    <img src="https://www.qastan.be/swfiles/files/71aa43_4103f7c99e7d47db98eb263ac8d6cfb1mv2-3-tab.jpg?nc=1715848923" alt="" className="w-12 h-12 rounded-full shadow-lg object-cover" />
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                <div className="relative h-full p-5 bg-slate-200 rounded-lg shadow-lg">
                  <div className="flex items-center -mt-1">
