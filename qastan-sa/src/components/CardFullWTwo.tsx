...
function CardFullWTwo() {
  return (
    <HelmetProvider>
      <Helmet>
        <title>Ontmoet Ons Team - Qastan</title>
        <meta
          name="description"
          content="Bij Qastan zijn we dol op automatisering en digitalisering. Ontmoet ons geweldige team van enthousiaste en gemotiveerde IT-professionals die jouw onderneming ondersteunen."
        />
      </Helmet>
      <div className="my-20">
