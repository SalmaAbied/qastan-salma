      ...
      <div className="container mx-auto pt-10 px-4">
        <div className="relative">
          <div className="py-10">
            <img
              src={post?.image}
              alt={post?.title}
              className="brightness-50 rounded-lg shadow-lg h-96 w-full object-cover"
            />
          </div>
          ...
          <div className="mb-10 absolute bottom-10 left-10">
            <button
              ...
              className="bg-darkorange font-bold text-white px-6 py-3 rounded-lg text-lg hover:bg-lightblue transition duration-300"
            >
              Solliciteer nu
            </button>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-8 bg-slate-50 rounded-lg shadow-lg p-4">
            ...
            <div className="col-span-1 md:col-span-3">
              <h1 className="text-xl font-bold mb-4">Dagelijkse taken</h1>
