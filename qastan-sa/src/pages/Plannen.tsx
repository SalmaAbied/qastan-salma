...
function Plannen() {
  ...
  return (
    <>
      ...
      <Banner title="Samen duiken in de planning van jouw onderneming?" description="We helpen je graag verder na een verkennend gesprek. We luisteren naar jouw noden, stellen een gepaste oplossing voor en laten je bedrijf vliegen!" buttonText="Vraag een gesprek aan" buttonLink="/Contact" bgcolor="darkblue" />
